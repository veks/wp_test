(function (factory) {
   ...
   * @return  void
   */
  var initializeBlock = function initializeBlock(accordion) {
    new Houdini(".".concat(accordion.classList[0]), {
      isAccordion: true,
      collapseOthers: true
    });
  };
  ...
  if (window.acf) {
    window.acf.addAction('render_block_preview/type=accordion', function (block) {
      var _block = block[0];
      var accordion = _block.querySelector('.accordion');
